...
\node[block] (v2) at (0,-0.75) {SDK-generated proxy};
\begin{scope}[on background layer]
	\draw [fill=green] (-2.75,2) rectangle (2.75,-1.5);
\end{scope}

\node[block] (v3) at (0,-2.25) {SDK-generated proxy};
\node[block] (v4) at (0,-3.5) {Library-generated proxy};
\node[block] (v5) at (0,-4.75) {C Library};
